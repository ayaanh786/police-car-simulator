...
function ToggleFullScreen() {
		...
		var buildUrl = "Build";
		var loaderUrl = buildUrl + "/Police Car Simulator.loader.js";
		var config = {
        dataUrl: buildUrl + "/Police Car Simulator.data",
        frameworkUrl: buildUrl + "/Police Car Simulator.framework.js",
        codeUrl: buildUrl + "/Police Car Simulator.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "Gamebol",
        productName: "Police Car Simulator",
        productVersion: "1.0",
      };
